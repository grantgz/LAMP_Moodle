...
# Step 3 Directories, ownership, permissions and php.ini required by 
...
echo "Root password for mySQL is : $MYSQL_ROOT_PASSWORD. Write it down and keeo it in a safe place."
sudo chmod -R 777 /var/www/moodle
echo "Step 5 has completed."


# Step 6 Secure the SQL Server and get instructions for completing the install in your browser.
sudo mysql_secure_installation
echo "Now go to your webaddress and complete the installation".
sudo chmod -R 755 /var/www/moodle
