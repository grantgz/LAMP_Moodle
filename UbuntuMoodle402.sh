...
sudo apt-get update
sudo apt upgrade -y
sudo apt-get install -y apache2 php8.1 libapache2-mod-php8.1 php8.1-mysql graphviz aspell git 
sudo apt-get install -y clamav php8.1-pspell php8.1-curl php8.1-gd php8.1-intl php8.1-mysql ghostscript
sudo apt-get install -y php8.1-xml php8.1-xmlrpc php8.1-ldap php8.1-zip php8.1-soap php8.1-mbstring
